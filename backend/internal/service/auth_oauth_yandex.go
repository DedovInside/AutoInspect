...
func (s *AuthService) handleExistingYandexIdentity(
	ctx context.Context,
...
func (s *AuthService) getOrCreateYandexUserByEmail(
	ctx context.Context,
	usersTx repository.UserRepository,
...
func (s *AuthService) processYandexOAuth(
	...
	if err := s.ensureYandexOAuthIdentity(ctx, identitiesTx, user, profile); err != nil {
		return nil, err
	}
