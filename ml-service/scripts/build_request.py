...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--correlation-id", default="corr-1")
    parser.add_argument("--user-id", default="user-1")
    parser.add_argument("--image-s3-keys", nargs="+", default=["uploads/a.jpg"])
    parser.add_argument("--parts-model-s3-key", default="models/v1/parts_segmentation.pt")
    parser.add_argument("--parts-config-s3-key", default="configs/parts_config.json")
    parser.add_argument("--car-make", default="Toyota")
    parser.add_argument("--car-model", default="Camry")
    parser.add_argument("--car-generation", default="XV70")
    parser.add_argument("--car-year", type=int, default=2022)
